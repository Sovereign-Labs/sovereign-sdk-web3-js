...
describe("Schema", () => {
  ...
  describe("eip712SigningHash", () => {
    it("should generate EIP712 signing hash for UnsignedTransaction", () => {
      ...
      expect(bytesToHex(signingHash)).toEqual("4afeb093d3faef4587d0074eac770e5cbde89c2392b3d5b1ae3f3674d53a8cc4");
    });
  });
});
